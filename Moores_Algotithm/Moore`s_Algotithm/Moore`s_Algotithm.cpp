	...
	for (int i = 0; i < 30; i++)
	{
		for (int j = 0; j < 30; j++)
		{
			if (setka_to_array[i][j] >= 1)
			{
				...
				if (i + 1 <= 29 && j - 1 >= 0 && setka_to_array[i + 1][j - 1] == 0) setka_to_array[i + 1][j - 1] = -1;
				if (i + 1 <= 29 && j + 1 <= 29 && setka_to_array[i + 1][j + 1] == 0) setka_to_array[i + 1][j + 1] = -1;
				if (i - 1 >= 0 && j - 1 >= 0 && setka_to_array[i - 1][j - 1] == 0) setka_to_array[i - 1][j - 1] = -1;
				if (i - 1 >= 0 && j + 1 <= 29 && setka_to_array[i - 1][j + 1] == 0) setka_to_array[i - 1][j + 1] = -1;
