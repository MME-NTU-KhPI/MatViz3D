...
- `--halfaxis_a <a> --halfaxis_b <b> --halfaxis_c <c> --ellipse_order <p> --orientation_angle_a <deg> --orientation_angle_b <deg> --orientation_angle_c <deg>` — Probability superellipsoid kernel and orientation controls (`--periodic` applies here too).
